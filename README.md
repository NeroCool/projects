**Заготовка веб-сервера (под ОС семейства GNU/Linux). Проект, который был финальным заданием к курсу по многопоточному программированию на С/С++ (stepik.org, от mail.ru).**
## Задание:
